...
export class SupplierQueryDto {
  ...
  @ApiPropertyOptional({
    ...
    example: 'createdAt',
    enum: ['id', 'storeId', 'personId', 'status', 'createdAt', 'updatedAt'],
  })
  @IsOptional()
  @IsString({ message: 'El campo de ordenamiento debe ser una cadena de texto' })
  @IsEnum(['id', 'storeId', 'personId', 'status', 'createdAt', 'updatedAt'], {
    message: 'El campo de ordenamiento debe ser id, storeId, personId, status, createdAt o updatedAt',
  })
  sortBy?: string;
